...
{
    public partial class fstReceipt : Form
    {

        string _name, _adress, _phone, _work, _logo;

        private void fstReceipt_FormClosing(object sender, FormClosingEventArgs e)
        {
            Comenzi comen = new Comenzi();
            comen.refreshgrid();
        }

        private void fstReceipt_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void fstReceipt_Load(object sender, EventArgs e)
        {
